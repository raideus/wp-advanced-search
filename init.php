...
function wpas_scripts() {
    wp_enqueue_script( 'wpas-globals', get_template_directory_uri() . '/' . basename(__DIR__) . '/js/global.js', array('jquery'), '1', false );
    wp_enqueue_script( 'wpas-ajax-scripts', get_template_directory_uri() . '/' . basename(__DIR__) . '/js/ajax.js', array('jquery','wpas-globals'), '1', false );
